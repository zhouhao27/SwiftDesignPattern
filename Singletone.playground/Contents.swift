...
class IoDHSingleTong {
    class StaticHolder {
        static let mInstance = IoDHSingleTong()
    }
    
    static func getInstance() -> IoDHSingleTong {
        return StaticHolder.mInstance
    }
    
    func display() {
        print("IoDHSingleTong Singleton")
    }
}
...
let ioDHSingleton = IoDHSingleTong.getInstance()
